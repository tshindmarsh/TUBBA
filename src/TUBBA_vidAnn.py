...
class VideoAnnotator(QWidget):
    ...
    def add_video(self):
        ...
        try:
            ...
            vidInfo = dlcToFeatures(folder, spatialSR)  # Assume no downsampling for new
    ...
    def train_TUBBAmodel(self):
        from TUBBA_train_XGB_LSTM import train_TUBBAmodel

        # Save first to ensure that all annotations are included
        print(f"Training model...")
        self.save_project()

        model_path = train_TUBBAmodel(self.project_path, window_size=50)
    ...
    def run_model_inference(self):
        ...
        from TUBBA_infer_XGB_LSTM import TUBBA_modelInference
